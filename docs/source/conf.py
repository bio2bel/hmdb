...
# -*- coding: utf-8 -*-
#
# hmdb documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'hmdb.tex', 'hmdb Documentation',
     'Colin Birkenbihl, Charles Tapley Hoyt', 'manual'),
]
